...
public class Gestor_Usuarios extends javax.swing.JFrame {
    ...
    public static String usuario2="", dato="";
    public static DefaultTableModel modulo=new DefaultTableModel();
    public static int sesion, ID=0, user_update=0;
    ...
    public Gestor_Usuarios(){
        ...
        setTitle("Usuarios registrados - Sesión de "+usuario2);
        ...
        try{
            ...
            PreparedStatement psp=cnn.prepareStatement("SELECT ID_USUARIO, NOMBRE_USUARIO, USERNAME, TIPO_NIVEL, ESTATUS FROM USUARIOS");
            ...
            tabla_usuarios.setFont(new Font("Sylfaen", 1, 12));
            Scroll.setFont(new Font("Sylfaen", 1, 12));
            
            modulo.addColumn("");
            modulo.addColumn("Nombre");
            modulo.addColumn("Usuario");            
            modulo.addColumn("Pemisos");
        ...
        tabla_usuarios.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent s){
                ...
                int columna=0;
                dato=(String)tabla_usuarios.getValueAt(fila, 2);
                user_update=(int)tabla_usuarios.getValueAt(fila, columna);
                if(fila>-1){
                    Info_Usuarios canal=new Info_Usuarios();
    ...
    private void tabla_usuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_usuariosMouseClicked
        ...
        int columna=2;
        if (fila>-1){
            user_update = (String) modulo.getValueAt(fila, columna);
            Info_Usuarios canal=new Info_Usuarios();
            canal.setVisible(true);
        }*/
